    ...
    return(
        <footer className = 'flex justify-between items-start p-20 bg-[#7163b0]'>
            <div className = 'flex-col items-start -ml-16 -mt-12'>
                <Link className = 'flex gap-1 text-[#ff8d46] text-[18px] lg:text-[24px] font-semibold' href={'/'}>
                    <Cat className = 'lg:h-[35px] lg:w-[35px]' color='#ff8d46'/>
                    <h2>Pet Patinhas</h2>
                </Link>
                <span className = 'text-[12px] lg:text-[20px] text-white'>Texto sobre a loja</span>
            ...
            <div className = 'flex flex-col justify-between items-end -mr-16 -mt-12 gap-3 lg:gap-6'>
                <address className = 'flex justify-between gap-1 text-[12px] lg:text-[20px] text-[#ff8d46] font-medium'>
                    <MapPin className = 'lg:h-[30px] lg:w-[30px]' color = '#ff8d46' size=  {20}/>
                    <Link href = {'/'}>Rua Tchurusbango Tchurusbago</Link>
                </address>
                <div className='flex justify-between gap-1 text-[12px] lg:text-[20px] text-[#ff8d46] font-medium'>
